...
Meteor.methods({
  ...
  //   var aFilePath = Assets.absoluteFilePath(`private/${fileName}`);
  //   console.log(aFilePath);
  //   fs.readFile(aFilePath, 'utf8', function (err, data) {
  //     if (err) {
  //       future.return(err)
  //     } else{
  ...
  //   });
  //   // return future.wait();
  //   // // fs.readFile(process.env.PWD + '/packages/glitchy/private/' + fileName, 'utf8', function (err, data) {
  //   //   if (err) {
  //   //     future.return(err)
  //   //   } else{
  //   //     var shader = glslify(`${data}`);
